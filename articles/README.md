...
| **note(日本語)の作品** | 別の **NOTE チーム**が担当 | このチームは [`../handoff/`](../handoff/) で引き継ぐ |

> note 公開作品は NOTE チームが別に存在するため、このチームでは**直接管理しません**。
> note 向けの素材・アングルが出たら、`handoff/handoff_note_<title>.md` を作って NOTE チームへ引き継ぎます。
