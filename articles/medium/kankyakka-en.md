...
tags: ["Decision Making", Productivity, "Self Improvement", Mindfulness, Zen]  # 5枠目 Zen は編集画面で Japan/Philosophy と比較（tag-tracker 参照）
created: 2026-07-26
published_url: ""
...
Ask a roomful of ambitious people what to do when the way forward is unclear, and most will answer with a plan for finding more light: more research, more scenarios, a clearer five-year view. The Zen instruction *kankyakka* (看脚下) — "look under your feet" — answers differently. It doesn't tell you to find the light again. It tells you where to look while you don't have it.
...
High achievers tend to treat uncertainty as a research problem — gather enough data, model enough scenarios, and the darkness will eventually resolve into a lit path. Sometimes it does. Often it doesn't, and the gathering becomes its own form of paralysis: elegant, well-footnoted, going nowhere.
...
## The discipline of the near step

There's a version of this for anyone who's ever felt behind — in a career, in a body of work, in a life that didn't map to the plan they once made. The instinct is to stare into the unlit distance and measure the gap. Kankyakka redirects that stare downward, to the step that is, right now, entirely within reach and entirely knowable.

Confidence, in this reading, isn't the feeling of seeing the whole path. It's the willingness to trust your footing on the part of it you can actually see.
