...
tags: ["Self-Reliance", "Self Improvement", Mindfulness, Mentorship, Zen]
created: 2026-09-07
published_url: ""
...
Somebody junior corners somebody senior after a meeting and asks for the real read — not the version given in front of the room, the actual assessment. Sometimes that gets a straight answer. Often what comes back looks more like Mazu's river: a question handed back instead of an answer, an instruction to go find out, a story with no attached moral. That can look like stonewalling. It's frequently the more honest response, because the read the junior person wants was built out of years the senior one spent getting it wrong first, and no single sentence carries those years across intact.

## Waiting for someone else's river

People ask books and podcasts and anyone further along the same path for an identical shortcut: a sentence, out there somewhere, that will finally make the anxious feeling legible, or the calling obvious, or the relationship make sense — if only the right person could be found to say it. Whatever eventually resolves those things rarely shows up as a sentence at all. It shows up as the river itself, swallowed slowly, one unremarkable mouthful at a time, long after anyone stopped expecting the answer to arrive from outside.

## In closing

Pang got his answer, and it wasn't an answer — it was a task built to outlast the question that produced it. Whatever he understood after that, he reached by trying to drink something no mouth could hold, not by being handed a description of the water.
