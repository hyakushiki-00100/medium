...
| 入鄽垂手 nittensuishu | **Leadership** | Self Improvement | Mindfulness | Mentorship | Zen | 新規（draft）。問答形式ではなく『十牛図』(廓庵師遠、12世紀・臨済宗)第十図＝到達後に泥だらけで笑いながら市場へ戻る絵と序・頌。先行する清居禅師版は第八図の空円相で終わっており、廓庵の弟子・慈遠の序文によれば廓庵はそれを不十分とし第九・第十図を追加(慈遠序文原文は本セッションのegress制限で間接確認に留まる)。専門性を積んだ人が現場からわずかに距離を置く位置に移りがちだという失敗を、到達後にあえて泥へ戻る姿勢で指摘。primary Leadership は katsu(喝、即時介入の一喝)・muinoshinnin(無位の真人、地位に頼らない在り方)と近接するが、本記事は「到達したあとに、まだ現場に戻るかどうか」という時間軸の角度で差別化。人物同士の問答ではなく画・頌の連作を扱う初のシリーズ記事のため、逐語性の検証観点も「発話」ではなく「序・頌の字句」に変更 |
