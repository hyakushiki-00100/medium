...
| 體露金風 tairokinpu | **Acceptance** | Self Improvement | Mindfulness | Resilience | Zen | 新規（draft）。碧巌録第二十七則＝僧「木が枯れ葉が落ちたらどうなるか」に、雲門文偃(864-949)が「体露金風(この身が金色の風にさらされる)」と答える。慰めも大げさな意味づけもせず、いま起きている事実だけを名指す返し方を扱う。「金風」が五行説で秋=金に対応する語であることを文化的具体物として紹介。確実な最古の出典は雪竇重顕(980-1052)の頌古集(c.1038、雲門没後約89年)とし、より早い記録の有無は確認できていない旨を明記。primary Acceptance はシリーズでの使用実績が少なく初出に近い(nichinichiのtag4で使用済みだがprimaryは初)。雲門文偃は本シリーズnichinichi(日日是好日)で既出だが、nichinichiは「価値の高い日/低い日という区別そのものへの拒絶」、本記事は「衰えを迎えたときに説明ではなく事実をそのまま差し出す」という別角度のテーマであり、出典も同じ碧巌録内の別則(第六則/第二十七則)のため重複しないことを確認済み |
