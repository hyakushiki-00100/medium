...
| 首山竹篦 shuzanshippei | **Critical Thinking** | Self Improvement | Mindfulness | Decision Making | Zen | 新規（draft）。無門関第四十三則(1228年成立/無門慧開1183-1260編)＝首山省念(926-994)が竹篦を掲げ「竹篦と呼べば触れて間違い、呼ばなければ背いて間違い、では何と呼ぶか」と問い、無門も評唱で沈黙も許さない(「不得有語、不得無語」)と念押しする。二択どちらも間違っているという罠そのものに気づけるかを問う内容。primary Critical Thinkingはシリーズでの使用実績が少なく初出に近い。首山の伝記は没後わずか約10年で成立した景徳伝灯録(1004)に収録されており、このシリーズでは異例に短い間隔だが、竹篦を掲げるこの問答自体がその伝記に含まれるかは確認できず、確実な最古の出典は無門関(1228、没後約234年)とした。文化的具体物として、竹篦(しっぺい)が現代日本語「しっぺ返し」の語源になっていることを紹介(道具の一般的用法についての事実であり、本則の逸話とは区別)。mu(趙州の無、二択の問いへの応答拒否)と一見近いが、muは特定の形而上学的問いへの応答そのものを退ける話、本記事は「二択の両方が誤りだと気づく」という判断・カテゴライズの話で角度が別。教師(首山省念・風穴延沼・汾陽善昭)いずれもシリーズ初出 |
