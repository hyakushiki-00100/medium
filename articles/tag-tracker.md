...
| 香厳撃竹 kyogen | **Expertise** | Self Improvement | Mindfulness | Personal Growth | Zen | 公開済み。潙山霊祐の問いに答えられず蔵書を焼いた香厳智閑＝知識と実感の違い。primary Expertise はシリーズ初。※kyukyoryutan(久嚮龍潭)とプロットの骨格(学僧が問いに答えられず知の蓄積を焼く)が酷似することが2026-08-27にfact-checkerで指摘済み。オーナー確認の上、両記事とも継続する方針(重複はシリーズ飽和による不可避なものとして許容) |
...
| 洞山過水 kasui | **Succession** | Self Improvement | Mindfulness | Mentorship | Zen | 新規（draft）。洞山良价(807-869)が師の雲巌曇晟(782-841)のもとを去る際「和尚の入滅後、和尚の真を得ているかと疑われたらどう答えるか」と問い、雲巌が「ただ『これがそれだ』とだけ答えよ」と返した逸話。のちに川を渡る際、水面に映る自分の姿を見て大悟し(景徳伝灯録巻十四)、曹洞宗の教え「五位」の土台となる偈を残す。師の答えが渡された時点では未完成に見えても、理解は後から別の場所で完成するという継承の構造を扱う。確実に確認できた最古の出典は景徳伝灯録(1004)であり、それより古い祖堂集(952)には師弟関係の記載はあるが本逸話自体の収録は確認できず、その旨を明記。primary Succession はシリーズ初出のタグ。洞山良价は本シリーズmukanjo(洞山無寒暑)で既出だが、mukanjoは寒暑を避けようとする動きそのものを問う、すでに一家をなした師としての洞山を扱うのに対し、本記事は雲巌のもとを去る若い修行僧としての洞山を扱っており、tokusantakuhatsu/kyukyoryutanにおける徳山と同型の「同一人物・別の人生の時期」による差別化。nittensuishu(入鄽垂手、到達後に現場へ戻るかどうか)とはメンターシップの角度で近接するが、本記事は「師が去る前に手渡した答えが、あとから完成する」という継承・伝達の構造を扱う点で角度が異なる |
