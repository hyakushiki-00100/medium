...
| 記事 | 1（主） | 2 | 3 | 4 | 5 | メモ |
|---|---|---|---|---|---|---|
| 平常心是道 byojoshin | **Mental Health** | Self Improvement | Mindfulness | Productivity | Zen | 新規（draft）。南泉・趙州の問答＝ピーク状態を追うほど道から遠ざかる。「特別な状態」志向へのアンチテーゼ。primary は当初 Productivity だったが ikkegoyo と重複のため Mental Health に変更 |
