...
| 趙州洗鉢 senpatsu | **Focus** | Self Improvement | Mindfulness | Productivity | Zen | 新規（draft）。無門関第七則(1228年成立)＝新参の僧が趙州従諗(778-897)に指導を乞い、「粥は食べたか」に「食べた」と答えると「では鉢を洗いに行け」と言われ、その場で有省(気づきを得た)という逸話。特別な教えと日常の作業を分けて考える発想そのものへの問い。確実な最古の出典は無門関ではなく、宏智正覚(1091-1157)の頌古(没年までに成立)であり無門関より数十年早いことを明記。それより早い祖堂集・景徳伝灯録への収録有無はネットワーク制限で確認できず「確認できていない」旨を明記。primary Focus はシリーズ初出のタグ。趙州は kissako(喫茶去、相手をカテゴリーで仕分けない)・byojoshin(平常心是道、師の南泉普願が主役で特別な状態を求めるな)で既出だが、本記事は趙州自身が主役で「特別な指示を求めるな」という別角度のため重複しない |
