# X thread — 吽 (Un) — 元記事: articles/medium/un-single-character-en.md

元URL(CTA用): https://medium.com/@mk3372/the-zen-word-un-%E5%90%BD-what-a-single-closed-mouth-character-teaches-us-about-silence-and-endings-c0ea2d91c832
...
**2/**
The character is Un (吽). It comes from Sanskrit hūṃ — the very last sound in the Siddham alphabet, made with the mouth fully closed.

"A" (阿) is the first sound, mouth wide open. "Un" is the last, mouth shut.

Between them: every sound that can be made.

---

**3/**
Look at the guardian statues (Niō) flanking a temple gate.

Right side: mouth open (agyō).
Left side: mouth shut (ungyō).

Same pattern at Shinto shrines with the komainu lion-dogs. That closed-mouthed figure IS "Un" — stillness right before or right after a word.
...
**7/**
"Un" has a second meaning: the power to properly finish things.

In daily life, finishing is harder than starting. The half-written proposal. "Let's catch up soon" — and never do. The meeting no one ends. The relationship left unresolved for years.
